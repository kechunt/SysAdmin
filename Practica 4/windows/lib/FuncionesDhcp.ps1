...
function Invoke-DhcpConfig {
    ...
    $Mask = '255.255.255.0'
    Write-Host '=================================================='
    Write-Host ' PRÁCTICA 2 — DHCP Windows Server'
    Write-Host '=================================================='
    Install-DhcpRole
    ...
    $dns = Read-IPv4 'DNS (IP del servidor DNS del laboratorio)' '10.10.10.10'
    ...
    if (-not $scope) {
        ...
        Write-Host 'Ámbito existente actualizado (idempotente).' -ForegroundColor Green
    }
