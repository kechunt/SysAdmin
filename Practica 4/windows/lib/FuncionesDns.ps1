# FuncionesDns.ps1 - Practica 3 (rol DNS, zona reprobados.com)
...
function Invoke-DnsConfig {
    ...
    Write-Host '=================================================='
    Write-Host ' PRACTICA 3 - DNS Windows Server'
    ...
    $gw = Read-OptionalIPv4 'Gateway (vacio = no tocar ruta)'
    $adapter = Get-LabAdapter
    $typed = Read-LabInput "Interfaz del segmento interno [$($adapter.Name)]"
